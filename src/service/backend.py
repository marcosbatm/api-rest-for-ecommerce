...
from src.models.product import CreateProductRequest
...
class EcommerceBackend:
    ...
    def create_product(self, productRequest: CreateProductRequest) -> dict:
        # Logica de negocio: round price to 2 decimal places
        productRequest.price = round(productRequest.price, 2)
        return {"data": self.database.add_product(productRequest)}
